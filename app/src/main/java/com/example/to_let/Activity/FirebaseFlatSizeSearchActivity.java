...
public class FirebaseFlatSizeSearchActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_flat_size_search);
    ...
    ValueEventListener valueEventListener=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            adapter = new FirebaseSearchAdapter (FirebaseFlatSizeSearchActivity.this, FirebaseSearchList);
    ...
    private void search(String str){
        ...
        for(FirebaseSearchModel object: FirebaseSearchList){
            if(object.getSize().toLowerCase().contains(str.toLowerCase())){
                myList.add(object);
            }
