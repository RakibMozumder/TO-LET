...
public class FirebasePriceSearch1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_price_search1);
    ...
    ValueEventListener valueEventListener=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            adapter = new FirebaseSearchAdapter(FirebasePriceSearch1Activity.this, FirebaseSearchList);
