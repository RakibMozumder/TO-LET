...
public class FirebaseRatingSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_rating_search);
    ...
    ValueEventListener valueEventListener=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            adapter = new FirebaseSearchAdapter(FirebaseRatingSearchActivity.this, FirebaseSearchList);
