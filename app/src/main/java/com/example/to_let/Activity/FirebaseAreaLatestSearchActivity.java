...
public class FirebaseAreaLatestSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_area_latest_search);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("PostInformation")
                .orderByChild("area").orderByChild("latest")
                // .equalTo("3")
                ;
    ...
    ValueEventListener valueEventListener=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            adapter = new FirebaseSearchAdapter (FirebaseAreaLatestSearchActivity.this, FirebaseSearchList);
