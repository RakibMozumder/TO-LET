...
public class FirebaseLatestPriceSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_latest_price_search1);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("PostInformation")
                .orderByChild("latest").orderByChild("price")
                // .equalTo("3")
                ;
    ...
    ValueEventListener valueEventListener=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            adapter = new FirebaseSearchAdapter (FirebaseLatestPriceSearchActivity.this, FirebaseSearchList);
