...
public class FirebaseAreaSearchActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_area_search);
       ...
       ValueEventListener valueEventListener=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
           ...
           // FirebaseSearchList.clear();
            ...
            adapter = new FirebaseSearchAdapter (FirebaseAreaSearchActivity.this, FirebaseSearchList);
