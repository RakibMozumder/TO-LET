...
public class FirebaseLatestSearchActivity extends AppCompatActivity  {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_firebase_latest_search);
  ...
  ValueEventListener valueEventListener=new ValueEventListener() {
    ...
    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
      ...
      adapter = new FirebaseSearchAdapter (FirebaseLatestSearchActivity.this, FirebaseSearchList);
  ...
  private void search(String str){
    ...
    for(FirebaseSearchModel object: FirebaseSearchList){
      if(object.getLatest().toLowerCase().contains(str.toLowerCase())){
        myList.add(object);
      }
