...
public class FirebaseBedLatestSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_bed_latest_search);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("PostInformation")
                .orderByChild("latest").orderByChild("bedroom")
                // .equalTo("3")
                ;
    ...
    ValueEventListener valueEventListener=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            adapter = new FirebaseSearchAdapter (FirebaseBedLatestSearchActivity.this, FirebaseSearchList);
