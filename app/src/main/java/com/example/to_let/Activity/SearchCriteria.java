...
public class SearchCriteria extends AppCompatActivity   {
    private Button areaButton,latestButton,priceButton,bedButton,ratingButton,sizeButton;
...
private RadioButton radioButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton=findViewById(R.id.searchButtonId1);
       ...
       // spinnerClasses = (NiceSpinner) findViewById(R.id.spinnerClass);
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(radioID==R.id.radioButtonAreaId) {
                    Intent intent = new Intent(SearchCriteria.this, FirebaseAreaSearchActivity.class);
                    startActivity(intent);
                }
                else if(radioID==R.id.radioButtonBedId) {
                    Intent intent = new Intent(SearchCriteria.this, FirebaseBedSearchActivity.class);
                    startActivity(intent);
                }
                else if(radioID==R.id.radioButtonLatestId) {
                    Intent intent = new Intent(SearchCriteria.this, FirebaseLatestSearchActivity.class);
                    startActivity(intent);
                }
                else if(radioID==R.id.radioButtonPriceId) {
                    Intent intent = new Intent(SearchCriteria.this, FirebasePriceSearchActivity.class);
                    startActivity(intent);
                }
                else if(radioID==R.id.radioButtonSizeId) {
                    Intent intent = new Intent(SearchCriteria.this, FirebaseFlatSizeSearchActivity.class);
                    startActivity(intent);
                }
            }
        });
...
*/
 ...
 /*   @Override
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        else if(text=="Two option"){
            Intent intent = new Intent(parent.getContext(), SearchCriteria2.class);
            startActivity(intent);
        }
